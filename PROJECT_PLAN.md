...
**Gemini billing enabled** (with a budget cap) to stop the recurring daily-quota wall — a second "fresh" key still exhausted at 6/16 parts, and the Gate 1 fix increases call volume per part going forward, not decreases it.
